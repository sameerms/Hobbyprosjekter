...
python $scripting/exercises/xygenerator.py 0:10,0.0001 'x*x' > datatrans.tmp

# run Python scripts:
echo "datatrans1.py: plain Python"
time $scripting/src/py/intro/datatrans1.py datatrans.tmp tmp.1

echo "datatrans2.py: Python using plain arrays"
...
rm -f  $scripting/src/efficiency/datatrans/C/datatrans1.app \
  $scripting/src/efficiency/datatrans/C++/datatrans1.app
