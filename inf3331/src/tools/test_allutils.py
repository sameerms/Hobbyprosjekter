...
modulecheck.message("Numeric", msg="for numerical computations")
modulecheck.message("numarray", msg="for numerical computations")
...
#   'pyfort'     : 'generator for Python interfaces to F77',
    ...
    'giftrans'   : 'tool for making GIF images transparent',
