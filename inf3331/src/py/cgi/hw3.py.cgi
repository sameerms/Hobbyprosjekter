...
Forms with many elements normally employ a table to organize the layout.
HTMLgen does not support this directly, but the small Python classes
InputTable, CheckBoxes, and
RadioButtons, taken from the Quick Python book (Ch. 25), can be used
to organize form elements in a table fashion. These classes have been
included in the HTMLgenutils module in src/tools and provide
some of the layout functionality in Perl's CGI::QuickForm module.
A trivial example on the usage of class InputTable is
shown in hw4.py.cgi.
