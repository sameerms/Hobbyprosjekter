...
class NumPyArray_Float : public PWOBase
{
 private:
  PyArrayObject* a;

 public:
  NumPyArray_Float () : PWOBase () { a=NULL; }
  ...
  NumPyArray_Float (double* data, int n1, int n2, int n3) 
    { wrap(data, n1, n2, n3); }
  NumPyArray_Float (PyArrayObject* array) 
    { a = array; PWOBase::GrabRef((PyObject*) a); }
