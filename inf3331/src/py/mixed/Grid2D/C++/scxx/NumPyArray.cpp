...
// seems that there is a fundamental problem with calling NumPy from C++!!!
// CXX as tool? probably smart...
// when we do the same in gridloop.cpp, in extern "C", things work...
