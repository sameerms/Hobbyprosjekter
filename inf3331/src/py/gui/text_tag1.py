...
(advanced-text2.py but we use class Command instead of lambda functions).
"""
from Tkinter import *
...
class HelloWorld:
	...
	self.hwtext.insert('end','\n')
        ...
        # class Command is an alternative to lambda functions:
	...
	self.hwtext.tag_bind('tag1','<Leave>',
            Command(self.configure, 'tag1','white'))
